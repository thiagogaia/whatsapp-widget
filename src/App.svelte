...
<script>
	export let tel = '+5531973493022'
	export let msg = 'Olá! Bem vindo ao nosso Whatsapp! Escreva aqui como podemos te ajudar.'
	export let chat = 'Olá! Como Podemos te ajudar?'
	export let title = 'Nuzap.com.br'
	export let url = 'https://nuzap.com.br'
	let via = !navigator.userAgent.match(/Android|iPhone|BlackBerry|IEMobile|Opera Mini/i) ? 'web' : 'api';
	function join() {
		window.open('https://' + via + '.whatsapp.com/send?phone=' + tel + '&text=' + encodeURIComponent(msg), null, 'noopener');
	}
...
<div class="joinchat joinchat--right joinchat--show " class:joinchat--chatbox={show} >
	<div class="joinchat__button" >
		<div class="joinchat__button__open" on:click={toggleChat}></div>
		<div class="joinchat__button__sendtext" on:click={join}>Abrir chat</div> 
		<svg class="joinchat__button__send" viewBox="0 0 400 400" stroke-linecap="round" stroke-width="33" on:click={join}> 
	...
	<div class="joinchat__box">
		<div class="joinchat__header"> 
			<a class="joinchat__powered" href="{url}" rel="nofollow noopener" target="_blank"> 
				<b>{title}</b>
			</a>
			<div class="joinchat__close" aria-label="Close" on:click={toggleChat}></div>
		</div>
		<div class="joinchat__box__scroll">
			<div class="joinchat__box__content">
				<div class="joinchat__message">{chat}</div>
			</div>
		</div>
	</div> 
